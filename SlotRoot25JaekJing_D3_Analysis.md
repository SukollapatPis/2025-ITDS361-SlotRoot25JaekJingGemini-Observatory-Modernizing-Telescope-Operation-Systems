...
<table border="1" width="100%">
  ...
  <tr>
    <td colspan="3">
      ...
      <br>
      <pre>
        <b>Astronomer:</b> ต้องการสร้าง Science Plan ที่ครบถ้วน ถูกต้อง และสามารถนำไปทดสอบหรือส่งตรวจได้โดยไม่เกิดข้อผิดพลาด
      </pre>
      </td>
  </tr>
  <tr>
...
<table border="1" width="100%">
  ...
  <tr>
    <td colspan="3">
      ...
      <br>
      <pre>
        <b>Astronomer:</b> ต้องการตรวจสอบว่า Science Plan สามารถปฏิบัติการได้จริงภายใต้ข้อจำกัดของหอดูดาว ไม่มีความขัดแย้งของพารามิเตอร์ และพร้อมสำหรับการส่งตรวจในขั้นตอนถัดไป
      </pre>
      </td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3">
      ...
      <ul>
        ...
        <li><b>6a ทดสอบไม่ผ่าน: </b>System ตรวจพบว่าค่าพารามิเตอร์ขัดแย้งกับข้อจำกัดทางกายภาพหรืออุปกรณ์ และยุติกระบวนการจำลอง จากนั้นแสดงสถานะ "ไม่ผ่าน" พร้อม Error Log และรายละเอียดข้อผิดพลาด พร้อมตัวเลือก "กลับไปแก้ไข" หรือ "ปิดหน้าจอ Simulation"</li>
        <li><b>6e ระบบล้มเหลวระหว่างการจำลอง: </b>System แสดงข้อผิดพลาดที่เกิดขึ้น และหยุดกระบวนการ</li>
      </ul>
    </td>
  </tr>
</table>
...
<table border="1" width="100%">
  ...
  <tr>
    <td colspan="3">
      ...
      <br>
      <pre>
        <b>Astronomer: </b>ต้องการส่ง Science Plan ที่ผ่านการทดสอบแล้วเข้าสู่กระบวนการตรวจสอบ เพื่อให้สามารถดำเนินการสังเกตการณ์จริงในขั้นตอนถัดไป และทราบสถานการณ์พิจารณาของแผน
        <b>Science Observer: </b>ต้องการได้รับ Science Plan ที่ครบถ้วน ถูกต้อง และพร้อมสำหรับการตรวจสอบ โดยไม่ต้องแก้ไขข้อผิดพลาดพื้นฐานก่อนดำเนินการต่อ
      </pre>
      </td>
  </tr>
  <tr>
...
<table border="1" width="100%">
  ...
  <tr>
    <td colspan="3">
      ...
      <br>
      <pre>
        <b>Science Observer: </b>ต้องการส่ง Science Plan ที่ผ่านการทดสอบแล้วเข้าสู่กระบวนการตรวจสอบ เพื่อให้สามารถดำเนินการสังเกตการณ์จริงในขั้นตอนถัดไป และทราบสถานการณ์พิจารณาของแผน
        <b>Astronomer: </b>ต้องการทราบผลการอนุมัติหรือข้อเสนอแนะเพื่อปรับปรุง Science Plan
      </pre>
      </td>
  </tr>
  <tr>
    ...
    <td colspan="3">
      <strong>Normal Flow of Events: </strong>
        <ol>
          ...
          <li>Science Observer กรอกผลการตรวจสอบ และให้ข้อเสนอแนะ</li>
...
<table border="1" width="100%">
  ...
  <tr>
    <td colspan="3">
      ...
      <br>
      <pre>
      <b>Science Observer: </b>ต้องการสร้าง Observing Program จาก Science Plan ที่อนุมัติแล้ว ให้พร้อมใช้งานในการสังเกตจริง โดยคงเจตนาของแผนและลดความเสี่ยงในการรันผิดพลาด <br>
      <b>Telescope Operator:  </b>ต้องการโปรแกรมที่รันได้จริง มีข้อมูลครบ และตรวจสอบย้อนกลับได้ว่ามาจาก Science Plan ใด
      </pre>
      </td>
  </tr>
  <tr>
