...
export default function CreateSciencePlan() {
    ...
    // ดึงข้อมูล User จาก localStorage เพื่อระบุชื่อ Creator
    const [creatorName, setCreatorName] = useState('Dr. Edwin Hubble');

    // 🟢 1. เพิ่ม State สำหรับควบคุมการเปิด-ปิด Discard Popup
    ...
    // 🟢 2. ฟังก์ชันสำหรับเปิด Popup เมื่อพยายามจะกดย้อนกลับหรือยกเลิก
    ...
    const handleSave = (e) => {
        ...
        // จำลองการบันทึกข้อมูลและส่งกลับหน้า Dashboard
    ...
    return (
        <>
            ...
            {/* 🟢 3. เพิ่มโครงสร้าง Modal แจ้งเตือน Discard Changes */}
            {showDiscardModal && (
                <div className="modal-overlay">
                    <div className="discard-modal">
                        ...
                        <div className="modal-footer-simple">
                            ...
                            <button className="btn-discard" onClick={() => navigate('/dashboard/astronomer')}>Discard Changes</button>
                        </div>
                    </div>
                </div>
            )}
            ...
            <div className="app">
                ...
                <main className="form-main">
                    <div className="form-header">
                        {/* 🟢 4. แก้ไขปุ่มลูกศรย้อนกลับให้เรียก handleBackAttempt */}
                    ...
                    <form className="form-card" onSubmit={handleSave}>
                            ...
                            <div className="form-grid-2">
                                ...
                                <div className="form-group">
                                    ...
                                    <select name="target" value={formData.target} onChange={handleChange}>
                                        <option value="M31 (Andromeda Galaxy)">M31 (Andromeda Galaxy)</option>
                                        <option value="M42 (Orion Nebula)">M42 (Orion Nebula)</option>
                        ...
                        <div className="form-section mt-5">
                            ...
                            <div className="form-grid-3">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="number" step="0.1" name="luminance" value={formData.luminance} onChange={handleChange} />
                                </div>
                                <div className="form-group">
                                    <label>Hue</label>
                                    <input type="number" step="0.1" name="hue" value={formData.hue} onChange={handleChange} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="form-actions">
                            {/* 🟢 5. แก้ไขปุ่ม Cancel ให้เรียก handleBackAttempt */}
...
// 🟢 6. เพิ่ม CSS ที่จำเป็นสำหรับ Discard Popup เข้าไปในตัวแปร css เดิม
const css = `
